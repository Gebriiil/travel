...
@section('content')
    ...
    <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ route('admin.get.contact.index') }}" class="active-bread">Contacts</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="note note-info">
        <h3> @lang('site.view') ( @lang('site.contacts') ) </h3>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    @if($contacts->count())
                        <form action="{{ route('admin.post.contact.deleteMulti') }}" method="post"
                              id="Form2"> @csrf </form>
                        ...
                        <table
                            ...
                            @foreach($contacts as $cat)
                                <tr class="odd gradeX draggable-item">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.get.contact.delete',$cat->id) }}" class="btn btn-danger conform-delete">
