...
<div class="note note-info">
    <h3> @lang('site.view') ( @lang('site.review') ) </h3>
</div>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a id="sample_editable_1_new" href="{{ route('admin.get.review.add') }}" class="btn sbold green"> @lang('site.add')
                ...
                @if($reviews->count())
               <form action="{{ route('admin.post.review.deleteMulti') }}" method="post" id="Form2"> @csrf </form>
               <form action="{{ route('admin.post.review.sort') }}" method="post" id="sortForm">@csrf</form>
                        ...
                        <tbody class="connected-sortable droppable-area1">
                            ...
                            <tr class="odd gradeX draggable-item">
                                ...
                                <td class="text-center">
                                    <img src="{{ getImage(REVIEW_PATH.'small/'.$sl->img) }}" class="privew-image img-thumbnail">
                                </td>
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            {!!show_potions('review',$sl->id,$sl->status)!!}                
                                        </ul>
                                    </div>
                                </td>

                                <td class="text-center">  
                                  <a href="{{ route('admin.get.review.seo',$sl->id) }}" class="btn btn-sm blue"> @lang('site.seo') </a> 
                                </td>
