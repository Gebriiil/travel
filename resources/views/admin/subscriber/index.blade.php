...
@section('content')
    ...
    <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ route('admin.get.subscriber.index') }}" class="active-bread">Subscribers</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="note note-info">
        <h3> @lang('site.view') ( @lang('site.subscribers') ) </h3>
    </div>
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    @if($subscribers->count())
                        <form action="{{ route('admin.post.subscriber.deleteMulti') }}" method="post"
                              id="Form2"> @csrf </form>
                        ...
                        <table
                            ...
                            @foreach($subscribers as $cat)
                                <tr class="odd gradeX draggable-item">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.get.subscriber.delete',$cat->id) }}" class="btn btn-danger conform-delete">
