...
@section('content')
    ...
    <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ route('admin.get.p2p.index') }}" class="active-bread">P2Ps</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="note note-info">
        <h3> @lang('site.view') ( @lang('site.p2ps') ) </h3>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    @if($p2ps->count())
                        <form action="{{ route('admin.post.p2p.deleteMulti') }}" method="post"
                              id="Form2"> @csrf </form>
                        ...
                        <table
                            ...
                            @foreach($p2ps as $cat)
                                <tr class="odd gradeX draggable-item">
                                    ...
                                    <td class="text-center"> {{ $cat->agent_name }} </td>
                                    <td class="text-center"> {{ $cat->responsible_name }} </td>
                                    <td class="text-center"> {{ $cat->country }} </td>
                                    <td class="text-center"> {{ $cat->email }} </td>
                                    <td class="text-center"> {{ $cat->phone }} </td>
                                    <td class="text-center"> {{ $cat->msg_title }} </td>
                                    <td class="text-center"> {{ $cat->msg_body }} </td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.get.p2p.delete',$cat->id) }}" class="btn btn-danger conform-delete">
