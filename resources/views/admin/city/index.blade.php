...
@section('content')
    ...
    <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ route('admin.get.city.index') }}"
                   class="active-bread">@lang('site.cities')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="note note-info">
        <h3> @lang('site.view') ( @lang('site.cities') ) </h3>
    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a id="sample_editable_1_new" href="{{ route('admin.get.city.add') }}"
                    ...
                    @if($cities->count())
                        <form action="{{ route('admin.post.city.deleteMulti') }}" method="post"
                              id="Form2"> @csrf </form>
                        ...
                        <table
                            ...
                            @foreach($cities as $city)
                                    <tr class="odd gradeX draggable-item">
                                        <input type="hidden" name="sort[]" multiple value="{{ $city->id }}"
                                               form="sortForm">
                                        <td class="text-center">
                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                <input type="checkbox" class="checkboxes" name="deleteMulti[]"
                                                       form="Form2" multiple value="{{ $city->id}}"/>
                                                <span></span>
                                            </label>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-left" role="menu">
                                                    ...
                                                    {!!show_potions('city',$city->id,$city->status)!!}
