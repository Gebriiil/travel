...
<div class="page-bar">
    ...
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.get.tour.index') }}" class="active-bread">Tours</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" method="post" action="{{ route('admin.post.tour.updateSeo') }}" enctype="multipart/form-data" class="">
