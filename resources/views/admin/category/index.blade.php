...
@section('content')
    ...
    <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ route('admin.get.category.index') }}" class="active-bread">@lang('site.categories')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="note note-info">
        <h3> @lang('site.view') ( @lang('site.categories') ) </h3>
    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a id="sample_editable_1_new" href="{{ route('admin.get.category.add') }}"
                                       class="btn sbold green"> @lang('site.add')
                    ...
                    @if($categories->count())
                        <form action="{{ route('admin.post.category.deleteMulti') }}" method="post"
                              id="Form2"> @csrf </form>
                        ...
                        <table
                            ...
                            @foreach($categories as $cat)
                                <tr class="odd gradeX draggable-item">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                ...
                                                {!!show_potions('category',$cat->id,$cat->status)!!}


                                                @if($cat->show_in_footer=='no')
                                                    <li>
                                                        <a href="{{ route('admin.get.category.showInFooter',$cat->id) }}"
                                                           class="confirm-show">
                                                            <i class="fa fa-eye"></i> Show in Footer </a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ route('admin.get.category.hideFromFooter',$cat->id) }}"
                                                           class="confirm-hide">
                                                            <i class="fa fa-eye"></i> Hide From Footer </a>
                                                    </li>
                                                @endif
                                                ...
                                                @if($cat->featured=='no')
                                                    <li>
                                                        <a href="{{ route('admin.get.category.showInHome',$cat->id) }}"
                                                           class="confirm-show">
                                                            <i class="fa fa-eye"></i> Show In Home </a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ route('admin.get.category.hideFromHome',$cat->id) }}"
                                                           class="confirm-hide">
                                                            <i class="fa fa-eye"></i> Hide From Home </a>
                                                    </li>
                                                @endif
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.get.subCategory.showSlice',$cat->id) }}"
                                           class="btn btn-sm btn-primary"> Childs </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.get.category.seo',$cat->id) }}"
                                           class="btn btn-sm btn-primary"> @lang('site.seo') </a>
                                    </td>
                        ...
                        <button class="btn btn-info btn-sm pull-right sort" type="submit"
                                form="sortForm"> @lang('site.sort') </button>
